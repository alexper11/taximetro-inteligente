     ...
     <html>
       <head>
          <link rel="stylesheet" href="css/estilos_virtual.css" 			type="text/css">
           <title> Sistema de modificacion de usuarios</title>
        </head>
       <body>
        <table width="100%" align=center cellpadding=5 border=0 bgcolor="black">
           ...
           <td valign="top" align=right>
              ...
              <font FACE="arial" SIZE=2 color="#FFFFFF"> <b><u><?php  echo "Tipo Usuario</u>:   ".$_SESSION["tipo_usuario"];?> </b></font><br>  
...
if ((isset($_POST["enviado"])))
  {
   ...
   $sqlu8 = "UPDATE usuarios set ocupacion='$ocupacion' where id='$id_usu_enc'"; 
   $resultsqlu8 = $mysqli->query($sqlu8);
   $sqlu9 = "UPDATE usuarios set mail='$mail' where id='$id_usu_enc'"; 
   $resultsqlu9 = $mysqli->query($sqlu9);
   if ($password != "")
     {
     $password_enc = md5($password);
     $sqlu10 = "UPDATE usuarios set passwd='$password_enc' where id='$id_usu_enc'"; 
   ...
   if (($resultsqlu1 == 1) && ($resultsqlu2 == 1) && ($resultsqlu3 == 1) && ($resultsqlu4 == 1) && ($resultsqlu5 == 1) && ($resultsqlu6 == 1) && ($resultsqlu7 == 1) && ($resultsqlu8 == 1) && ($resultsqlu9 == 1))
         header('Location: interfaz_administrador.php?mensaje=1');
   else
         header('Location: interfaz_administrador.php?mensaje=2');
...
<select name=activo required> 
    ...
    <?php
       ...
       <tr>
       <td bgcolor="#D1E8FF" align=center> 
          <font FACE="arial" SIZE=2 color="#000044"> <b>Placa vehiculo</b></font>  
        </td>
        <td bgcolor="#EEEEEE" align=center> 
          <font FACE="arial" SIZE=2 color="#000044"> <b>No aplica</b></font> 
        </td> 
       </tr>
        <?php
          }
       ...
       <td bgcolor="#D1E8FF" align=center> 
        ...
        <td bgcolor="#D1E8FF" align=center> 
          <font FACE="arial" SIZE=2 color="#000044"> <b>Mail</b></font>  
        </td>
        <td bgcolor="#EEEEEE" align=center> 
